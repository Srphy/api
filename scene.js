...
loader.load(
		...
		const audioLoader3 = new THREE.AudioLoader();
		audioLoader3.load( './assets/sounds/click.wav', function( buffer ) {
		sound3.setBuffer( buffer );
		sound3.setLoop( false );
		sound3.setVolume( 0.3 );
...
loader.load(
	'./assets/obj/parquet.obj', function (object) {

	 object.traverse(function(child){child.castShadow = true;});
	 object.traverse(function(child){child.receiveShadow = true;});

	 woodTexture = new THREE.TextureLoader().load( './assets/textures/parquetD.jpg' );
	 woodTexture.wrapS = woodTexture.wrapT = THREE.RepeatWrapping;
	woodTexture.repeat.set(5, 5);

	 woodSpec = new THREE.TextureLoader().load( './assets/textures/parquetS.jpg' );
	 woodSpec.wrapS = woodSpec.wrapT = THREE.RepeatWrapping;
		woodSpec.repeat.set(5, 5);

	 woodNorm = new THREE.TextureLoader().load( './assets/textures/parquetN.jpg' );
...
loader.load(
	'./assets/obj/parquet2.obj', function (object) {

	 object.traverse(function(child){child.castShadow = true;});
	 object.traverse(function(child){child.receiveShadow = true;});

	 woodTexture2 = new THREE.TextureLoader().load( './assets/textures/parquetD.jpg' );
	 woodTexture2.wrapS = woodTexture2.wrapT = THREE.RepeatWrapping;
	woodTexture2.repeat.set(5, 5);

	 woodSpec2 = new THREE.TextureLoader().load( './assets/textures/parquetS.jpg' );
	 woodSpec2.wrapS = woodSpec2.wrapT = THREE.RepeatWrapping;
		woodSpec2.repeat.set(5, 5);

	 woodNorm2 = new THREE.TextureLoader().load( './assets/textures/parquetN.jpg' );
...
Bati1.load(
		'./assets/obj/porte/bati.obj', function (object) {
...
Seuil1.load(
		'./assets/obj/porte/seuil.obj', function (object) {
...
const Sonette1 = new THREE.OBJLoader();
Seuil1.load(
		'./assets/obj/porte/sonnette.obj', function (object) {
		...
		domEvents.addEventListener(sonnette, 'click', function(event){
		  ...
		  audioLoader8.load( './assets/sounds/ding.wav', function( buffer ) {
...
Porte1.load(
		'./assets/obj/porte/porte.obj', function (object) {
	
		object.position.x = 0.548;
          object.position.z = 1.554;
          object.rotation.y = 0;
	
		doorTexture = new THREE.TextureLoader().load( './assets/textures/porteD.jpg' );


		doorSpec = new THREE.TextureLoader().load( './assets/textures/porteS.jpg' );


		doorNorm = new THREE.TextureLoader().load( './assets/textures/porteN.jpg' );
		...
		audioLoader.load( './assets/sounds/knock.wav', function( buffer ) {
	   ...
	   domEvents.addEventListener(porte, 'dblclick', function( event ){
		...
		audioLoader5.load( './assets/sounds/porte2.mp3', function( buffer ) {
...
loader.load(
			'./assets/obj/escalier.obj', function (object) {
	   
			object.traverse(function(child){child.castShadow = true;});
			object.traverse(function(child){child.receiveShadow = true;});
	   
			stairsTexture = new THREE.TextureLoader().load( './assets/textures/escalierD.jpg' ); 
			stairsSpec = new THREE.TextureLoader().load( './assets/textures/escalierS.jpg' );
			stairsNorm = new THREE.TextureLoader().load( './assets/textures/escalierN.jpg' );
...
loader.load(
   		'./assets/obj/tuiles1-1.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles1-2.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles1-3.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles2-1.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles2-2.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles2-3.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles3-1.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles3-2.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles3-3.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles4-1.obj', function (object) {
...
loader.load(
    	'./assets/obj/tuiles4-2.obj', function (object) {
...
loader.load(
   		 './assets/obj/faitieres.obj', function (object) {
...
loader.load(
	'./assets/obj/plafonds2.obj', function ( object ) {
...
loader.load(
    	'./assets/obj/iso.obj', function (object) {			

		object.traverse(function(child){child.castShadow = true;});
		object.traverse(function(child){child.receiveShadow = true;});

		isolTexture = new THREE.TextureLoader().load( './assets/textures/cotonD.jpg' );
    	isolTexture.wrapS = isolTexture.wrapT = THREE.RepeatWrapping;
    	isolTexture.repeat.set(10, 10);
		isolNorm = new THREE.TextureLoader().load( './assets/textures/cotonN.jpg' );
...
loader.load(
    	'./assets/obj/iso2.obj', function (object) {			

		object.traverse(function(child){child.castShadow = true;});
		object.traverse(function(child){child.receiveShadow = true;});

		isol2Texture = new THREE.TextureLoader().load( './assets/textures/isoD.jpg' );
		isol2Norm = new THREE.TextureLoader().load( './assets/textures/isoN.jpg' );
...
Bati.load(
		'./assets/obj/fenetre/bati.obj', function (object) {
...
Vantail1.load(
		'./assets/obj/fenetre/vantail1.obj', function (object) {
...
Vantail2.load(
		'./assets/obj/fenetre/vantail2.obj', function (object) {
		...
		scene.add ( group7 );
          ...
          domEvents.addEventListener(group7, 'click', function( event ){
               ...
               const animate4 = () => {
                    ...
                    const audioLoader = new THREE.AudioLoader();
                    audioLoader.load( './assets/sounds/knock.mp3', function( buffer ) {
                    sound.setBuffer( buffer );
                    sound.setLoop( false );
                    sound.setVolume( 0.5 );
          ...
          domEvents.addEventListener(group7, 'dblclick', function( event ){
               ...
               const animate3 = () => {
                    ...
                    audioLoader2.load( './assets/sounds/porte2.mp3', function( buffer ) {
...
Vitre1.load(
		'./assets/obj/fenetre/vitre1.obj', function (object) {
...
Vitre2.load(
		'./assets/obj/fenetre/vitre2.obj', function (object) {
...
loader.load(
	'./assets/obj/fenetre/volet1.obj', function (object) {
	
		object.traverse(function(child){child.castShadow = true;});
		object.traverse(function(child){child.receiveShadow = true;});
		
		voletsTexture = new THREE.TextureLoader().load( './assets/textures/voletsD.jpg' );
		voletsSpec = new THREE.TextureLoader().load( './assets/textures/voletsS.jpg' );
		voletsNorm = new THREE.TextureLoader().load( './assets/textures/voletsN.jpg' );
	...
	loader.load(
		'./assets/obj/fenetre/volet2.obj', function (object) {
		...
		domEvents.addEventListener(group18, 'click', function( event ){
			...
			const animate4 = () => {
				 ...
				 audioLoader6.load( './assets/sounds/knock.mp3', function( buffer ) {
		...
		domEvents.addEventListener(group18, 'dblclick', function( event ){
			...
			const animate3 = () => {
				 ...
				 audioLoader7.load( './assets/sounds/volet1.mp3', function( buffer ) {
...
loader.load(
	'./assets/obj/fenetre/volet4.obj', function (object) {
	...
	loader.load(
		'./assets/obj/fenetre/volet3.obj', function (object) {
...
Ljoues1.load(
		...
		houseNorm = new THREE.TextureLoader().load( './assets/textures/houseN2.jpg' );
...
Lcharpente2.load(
		'./assets/obj/lucarnes/2/Lcharpente2.obj', function (object) {
...
Lliteaux2.load(
		'./assets/obj/lucarnes/2/Lliteaux2.obj', function (object) {
...
Ltuiles2.load(
		'./assets/obj/lucarnes/2/Ltuiles2.obj', function (object) {
...
Lfaitieres2.load(
		'./assets/obj/lucarnes/2/Lfaitieres2.obj', function (object) {
...
Ljoues2.load(
		'./assets/obj/lucarnes/2/Ljoues2.obj', function (object) {			
...
Lnoues2.load(
		'./assets/obj/lucarnes/2/Lnoues2.obj', function ( object ) {
...
Lciment2.load(
		'./assets/obj/lucarnes/2/Lciment2.obj', function ( object ) {
...
Lfenetre2.load(
		'./assets/obj/lucarnes/2/Lfenetre2.obj', function ( object ) {
...
boisseau1.load(
		'./assets/obj/cheminee/boisseau.obj', function (object) {
		
		object.traverse(function(child){child.castShadow = true;});
		object.traverse(function(child){child.receiveShadow = true;});
		house3Norm = new THREE.TextureLoader().load( './assets/textures/houseN2.jpg' );
...
chapeau1.load(
		'./assets/obj/cheminee/chapeau.obj', function (object) {
...
bavette1.load(
		'./assets/obj/cheminee/bavette.obj', function (object) {
...
solin1.load(
		'./assets/obj/cheminee/solin.obj', function (object) {
...
Perg1.load(
		'./assets/obj/pergola.obj', function (object) {
...
loader.load(
	...
	floorTexture = new THREE.TextureLoader().load( './assets/textures/GrassD.jpg' );
...
loader.load(
	'./assets/obj/mud.obj', function (object) {			

	object.traverse(function(child){child.castShadow = true;});
	object.traverse(function(child){child.receiveShadow = true;});

	mudTexture = new THREE.TextureLoader().load( './assets/textures/mudD.jpg' );
	mudTexture.wrapS = mudTexture.wrapT = THREE.RepeatWrapping;
	mudTexture.repeat.set(10, 10);

	mudNorm = new THREE.TextureLoader().load( './assets/textures/mudN.jpg' );
	mudNorm.wrapS = mudNorm.wrapT = THREE.RepeatWrapping;
	mudNorm.repeat.set(10, 10);

	mudSpec = new THREE.TextureLoader().load( './assets/textures/mudD.jpg' );
...
loader.load(
	'./assets/obj/path.obj', function (object) {			

	object.traverse(function(child){child.castShadow = true;});
	object.traverse(function(child){child.receiveShadow = true;});

	gravelTexture = new THREE.TextureLoader().load( './assets/textures/gravelD.jpg' );
	gravelTexture.wrapS = gravelTexture.wrapT = THREE.RepeatWrapping;
	gravelTexture.repeat.set(4, 4);

	gravelNorm = new THREE.TextureLoader().load( './assets/textures/gravelN.jpg' );
	gravelNorm.wrapS = gravelNorm.wrapT = THREE.RepeatWrapping;
	gravelNorm.repeat.set(4, 4);

	gravelSpec = new THREE.TextureLoader().load( './assets/textures/gravelS.jpg' );
...
loader.load(
	'./assets/obj/hedges.obj', function (object) {			

	object.traverse(function(child){child.castShadow = true;});
	object.traverse(function(child){child.receiveShadow = true;});

	hedgeTexture = new THREE.TextureLoader().load( './assets/textures/hedgeD.jpg' );
	hedgeNorm = new THREE.TextureLoader().load( './assets/textures/hedgeN.jpg' );
	hedgeSpec = new THREE.TextureLoader().load( './assets/textures/hedgeS.jpg' );
...
loader.load(
	 './assets/obj/lampe-bloc.obj', function (object) {
...
loader.load(
	 './assets/obj/lampe-globe.obj', function (object) {
...
loader.load(
	 './assets/obj/lampe-bloc2.obj', function (object) {
...
loader.load(
	 './assets/obj/lampe-globe2.obj', function (object) {
...
const ground = new THREE.PlaneGeometry( 1000, 1000, 10, 10 );
	 ...
	 mesh.castShadow = true;
		...
		domEvents.addEventListener(mesh, 'click', function(event){
			...
			audioLoader4.load( 'assets/sounds/ground.wav', function( buffer ) {
...
skyMap = new THREE.TextureLoader().load( './assets/textures/envmap.jpg' );
